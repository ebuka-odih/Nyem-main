        ...
        <div className="flex-1 bg-white w-full rounded-t-[36px] px-8 pt-12 pb-6 flex flex-col shadow-[0_-10px_40px_rgba(0,0,0,0.2)] animate-in slide-in-from-bottom duration-500">
            ...
            <form onSubmit={handleSubmit} className="space-y-8 flex-1">
                ...
                <div className="flex flex-col space-y-2">
                    ...
                    <input 
                        ...
                        className="border-b border-gray-200 pb-2 text-gray-600 placeholder-gray-400 focus:outline-none focus:border-brand font-medium text-lg w-full bg-transparent transition-colors"
                    />
                </div>
                ...
                <div className="flex flex-col space-y-2 relative">
                    ...
                    <div className="relative">
                        <input 
                            ...
                            placeholder="........" 
                            className="border-b border-gray-200 pb-2 text-gray-600 placeholder-gray-400 focus:outline-none focus:border-brand font-medium text-lg w-full bg-transparent pr-10 tracking-widest transition-colors"
                        />
                        <button 
                            type="button"
            ...
            <div className="mt-auto pt-6 text-center">
                <p className="text-gray-500 text-sm font-semibold">
                    Don't have account? <button onClick={onSignUp} className="text-brand font-bold hover:underline">Sign up</button>
                </p>
            </div>
